...
import HonestyImage from '../../images/honesty.jpg'
    ...
    <main className='flex flex-col max-w-screen-xl mx-auto divide-y'>
      ...
      <div className='flex flex-col mt-6 text-4xl font-semibold'>
        ...
        <div className='flex flex-row space-between mx-auto max-w-screen-xl'>
          ...
          <HomePageBox header={'Collaboration'} imageSrc={CollaborationImage.src} description={'I enjoy teaching what I know to others. I\'ll try to do this by mentoring or even by my blog posts (check them out!)'} color='bg-tertiary-color'/>
          </div>
          <div className='my-10 -mx-5'>
          <HomePageBox header={'Honesty'} imageSrc={HonestyImage.src} description={'I consider myself an honest person - and I feel it is a quality that has placed me in a fortuitous position throughout my career. I appreciate those around me being honest too, it really helps everyone get the best out of each other.'} color='bg-secondary-color'/>
          </div>
          <div className='my-20 -mx-5'>
          <HomePageBox header={'Learning'}  imageSrc={LearningImage.src} description={'If there\'s anything I feel is true about software development, it\'s that you\'re always learning. If this wasn\'t something I deemed important and found immense enjoyment in, I\'d be in the wrong line of work.'} color='bg-fourth-color'/>
          </div>
        </div>
      </div>
    </main>
